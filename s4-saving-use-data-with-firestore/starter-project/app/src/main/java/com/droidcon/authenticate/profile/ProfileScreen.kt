...
fun ProfileScreen(
  ...
  Box(modifier = Modifier.fillMaxSize()) {
    ...
    Column(
      ...
      UserProperty(label = stringResource(id = R.string.email_address), value = uiState.userEmail)
      Spacer(modifier = Modifier.height(8.dp))
      ...
      Button(modifier = Modifier
        ...
        Text(text = stringResource(R.string.profile_sign_out), modifier = Modifier.weight(1f), textAlign = TextAlign.Center)
      }
      ...
      Button(
        ...
        Text(text = stringResource(R.string.profile_delete_account), modifier = Modifier.weight(1f), textAlign = TextAlign.Center)
      }
